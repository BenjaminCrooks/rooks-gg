...
var participantIndvSchema = new mongoose.Schema({
	allInPings: Number,
...
var participantTestSchema = new mongoose.Schema({
	matchId: String,
	participants: participantIndvSchema
}, {collection: "participants", versionKey: false})

module.exports = mongoose.model("participants", participantTestSchema)